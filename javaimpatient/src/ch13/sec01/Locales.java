...
public class Locales {
  public static void main(String[] args) {
    System.out.println(NumberFormat.getNumberInstance(Locale.ENGLISH).format(123456.78));
    System.out.println(NumberFormat.getNumberInstance(Locale.GERMAN).format(123456.78));

    DateTimeFormatter formatter = DateTimeFormatter.ofLocalizedDate(FormatStyle.SHORT);
    LocalDate date = LocalDate.of(1961, 3, 22);
    System.out.println(formatter.withLocale(Locale.ENGLISH).format(date));
    System.out.println(formatter.withLocale(Locale.GERMAN).format(date));
    System.out.println(formatter.withLocale(Locale.CHINESE).format(date));
